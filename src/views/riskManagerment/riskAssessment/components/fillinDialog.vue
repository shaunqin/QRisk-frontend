...
export default {
  ...
  methods: {
    ...
    addHazard() {
      ...
      this.form.hazardList[
        this.form.hazardList.length - 1
      ].riskLevel1 = this.riskLevel1List[0].value
      this.chooseRiskLevel1(
        this.form.hazardList[this.form.hazardList.length - 1].riskLevel1,
        this.form.hazardList[this.form.hazardList.length - 1]
      )
    },
    delHazard(index) {
