<template>
  <div class="content">
    ...
    <el-input v-model="desc1_1" placeholder size="mini">
    ...
    <h4>四、月度点评与风险防控</h4>
    <el-input v-model="desc4" size="mini" placeholder type="textarea" rows="3"></el-input>
  </div>
</template>

<script>
import echart from "@/components/Charts";
import { getRiskAssessmentChartData } from "@/api/infodb";
